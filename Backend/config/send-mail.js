...
const transporter = nodemailer.createTransport({
  ...
  auth: {
    ...
    pass: "stxfakwnfladerbt",
  },
});

module.exports = async (senderAddress, name, link) => {
  let error = false;
  try {
                  ...
                  <tr>
                    <td class="content-cell">
                      <div class="f-fallback">
                        <h1>Hi ${name},</h1>
                        <p>You recently requested to reset your password for your BookEasy account. Use the button below to reset it.<br><strong>This password reset is only valid for the next 30 minutes.</strong></p>
                        <!-- Action -->
